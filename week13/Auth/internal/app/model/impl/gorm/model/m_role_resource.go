...
var _ model.IRoleResource = (*RoleResource)(nil)

// RoleResourceSet 注入RoleResource
var RoleResourceSet = wire.NewSet(wire.Struct(new(RoleResource), "*"), wire.Bind(new(model.IRoleResource), new(*RoleResource)))
...
func (a *RoleResource) Query(ctx context.Context, params schema.RoleResourceQueryParam, opts ...schema.RoleResourceQueryOptions) (*schema.RoleResourceQueryResult, error) {
	...
	db := entity.GetRoleResourceDB(ctx, a.DB)
