...
import (
	...
	// 引入swagger
	"github.com/LyricTian/gin-admin/v6/internal/app/swagger"
)
...
func Init(ctx context.Context, opts ...Option) (func(), error) {
	...
	// 初始化依赖注入器
	injectorInstance, injectorCleanFunc, err := injector.BuildInjector()
	if err != nil {
		return nil, err
	}
	...
	//	err = injectorInstance.MenuBll.InitData(ctx, config.C.Menu.Data)
	//	if err != nil {
	//		return nil, err
	//	}
	//}
